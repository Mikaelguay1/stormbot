	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					...
					wait: '❬❗❭ 𝐭𝐨̂ 𝐟𝐚𝐳𝐞𝐧𝐝𝐨 𝐦𝐚𝐜𝐚𝐜𝐨🐒...',
					success: '️❬ ✔ ❭ 𝑑𝑒𝑢 𝑏𝑜𝑚 𝑑𝑒𝑢𝑠 𝑒́ 𝑓𝑖𝑒𝑙',
					levelon: '❬ ✔ ❭ *leveling* *ativado*',
					leveloff: ' ❬ X ❭  *leveling* *desativado*',
					levelnoton: '❬ X ❭ *leveling não ativado*',
					levelnol: '*error* 0 °-°',
					error: {
				stick: '*𝒐𝒑𝒐𝒓𝒓𝒂 𝒅𝒆𝒖 𝒏𝒂̃𝒐, 𝒕𝒆𝒏𝒕𝒆 𝒏𝒐𝒗𝒂𝒎𝒆𝒏𝒕𝒆...😔*',
      		...
      		mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD PRIVATE BOT*',
					...
					ownerG: '[❗] sasuke? Este é um recurso especial para o sasuke ou storm❌',
					ownerB: '[❗] sasuke? Este é um recurso especial para o sasuke ou storm❌',
			...
			const ownerNumber = ["557798100035@s.whatsapp.net"] // coloque seu numero
			const mod = [ownerNumber,"557798100035@s.whatsapp.net"]//seu numero
			const adminbotnumber = ["557798100035@s.whatsapp.net"]//seu numero
			const frendsowner = ["557798100035@s.whatsapp.net"]//seu numero
			const premium = ["557798100035@s.whatsapp.net","5511964111522@s.whatsapp.net",] 
